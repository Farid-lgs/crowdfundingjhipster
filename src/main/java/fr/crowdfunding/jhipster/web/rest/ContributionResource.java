...
/**
 * REST controller for managing {@link fr.crowdfunding.jhipster.domain.Contribution}.
 */
@RestController
@RequestMapping("/api")
public class ContributionResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/contributions/{id}", consumes = "application/merge-patch+json")
