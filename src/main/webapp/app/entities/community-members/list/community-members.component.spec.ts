...
describe('Component Tests', () => {
  describe('CommunityMembers Management Component', () => {
    let comp: CommunityMembersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommunityMembersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.communityMembers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
