...
@Component({
  selector: 'jhi-community-members',
...
export class CommunityMembersComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.communityMembersService
      ...
      .subscribe(
        (res: HttpResponse<ICommunityMembers[]>) => {
  ...
  trackId(index: number, item: ICommunityMembers): number {
    return item.id!;
  }

  delete(communityMembers: ICommunityMembers): void {
    const modalRef = this.modalService.open(CommunityMembersDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.communityMembers = communityMembers;
  ...
  protected onSuccess(data: ICommunityMembers[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
