...
describe('Component Tests', () => {
  describe('BalanceTransfer Management Component', () => {
    let comp: BalanceTransferComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BalanceTransferComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.balanceTransfers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
