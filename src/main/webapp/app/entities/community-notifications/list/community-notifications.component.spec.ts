...
describe('Component Tests', () => {
  describe('CommunityNotifications Management Component', () => {
    let comp: CommunityNotificationsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommunityNotificationsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.communityNotifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
