...
export class ProjectImagesComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.projectImagesService
      ...
      .subscribe(
        (res: HttpResponse<IProjectImages[]>) => {
  ...
  trackId(index: number, item: IProjectImages): number {
    return item.id!;
  }
  ...
  delete(projectImages: IProjectImages): void {
    const modalRef = this.modalService.open(ProjectImagesDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.projectImages = projectImages;
  ...
  protected onSuccess(data: IProjectImages[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
