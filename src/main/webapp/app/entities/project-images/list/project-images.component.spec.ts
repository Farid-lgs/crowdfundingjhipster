...
describe('Component Tests', () => {
  describe('ProjectImages Management Component', () => {
    let comp: ProjectImagesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProjectImagesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.projectImages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
