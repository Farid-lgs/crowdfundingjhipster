...
describe('Component Tests', () => {
  describe('ProjectAccount Management Component', () => {
    let comp: ProjectAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProjectAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.projectAccounts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
