...
export class GlobalVariables {
  ...
  personalSubbarBtns: Array<{path: string, logo: string, txt: string}> = [{path: `${this.login}`, logo: '', txt:'Détails'}, {path: 'project', logo: '', txt:'Projets'}, {path: 'community', logo: '', txt:'Communautés'}];
