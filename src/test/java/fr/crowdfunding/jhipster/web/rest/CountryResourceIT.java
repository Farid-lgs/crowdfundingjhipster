...
import fr.crowdfunding.jhipster.domain.Country;
import fr.crowdfunding.jhipster.repository.CountryRepository;
import fr.crowdfunding.jhipster.service.dto.CountryDTO;
import fr.crowdfunding.jhipster.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).nameFr(DEFAULT_NAME_FR);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).nameFr(UPDATED_NAME_FR);
        return country;
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).nameFr(UPDATED_NAME_FR);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).nameFr(UPDATED_NAME_FR);
